...
const staffController = {
    ...
    // Get members – now supports 'all' for landlord and search
    ...
    // Get members with account status – supports 'all' and now also search/role filters
    async getMembersWithAccounts(req, res) {
        try {
            const { apartmentId } = req.params;
            const { role_id, search } = req.query;   // accept filters
